...
export(NodePath) onready var slot_dpad_label = $CenterContainer/VBoxContainer/Equipped_Slot/Panel/Groups/Dpad_Group/HBoxContainer/Dpad_Label
export(NodePath) onready var slot_face_label = $CenterContainer/VBoxContainer/Equipped_Slot/Panel/Groups/Face_Group/HBoxContainer/Face_Label
export(NodePath) onready var slot_input_label = $CenterContainer/VBoxContainer/Equipped_Slot/Panel/Groups/Input_Group/HBoxContainer/Input_Label
...
func _setup_panel(skill: Skill_Data, slot: Dictionary = {"dpad_group": "NONE", "face_group": "NONE", "input_group": "NONE"}):
	...
	slot_dpad_label.text = slot["dpad_group"]
	slot_face_label.text = slot["face_group"]
	slot_input_label.text = slot["input_group"]
