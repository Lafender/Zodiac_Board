...
func _build_grid() -> void:
	...
	for k in inventory.item_sums.keys():
		var chip: Skill_Data = inventory.get_item_resource(inventory.item_sums[k])
		var panel: Skill_Chip_Panel = preload("res://Interface/Panel/Skill_Chip_Panel/Skill_Chip_Panel.tscn").instance()
